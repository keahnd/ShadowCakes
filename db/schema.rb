...
ActiveRecord::Schema.define(version: 2021_06_07_054004) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.boolean "payment_reminder", default: false
    t.boolean "order_delete_reminder", default: false
